				...
				<div class="panel panel-default">
					...
					<div class="panel-body table-responsive" id="body">
						<div id="usuarios">
							...
							{{Form::close()}}
							<table class="table table-hover table-striped col-md-12 col-xs-12 col-lg-12 col-xl-12">
								<thead>
									<th>Nombre</th>
									<th>Correo</th>
									<th>Tipo</th>
						...
						<div id="ubicacioneslist" >
							<a href="#" id="ubicacion-popup" class="btn btn-info col-md-2 col-xs-12 col-lg-4 col-xl-2">Agregar Ubicacion</a>
							<table class="table table-hover table-striped col-md-12 col-xs-12 col-lg-12 col-xl-12">
								<thead>
									<th>Pais</th>
									<th>Ciudad</th>
						...
						<div id="universidadeslist">
							<a href="#" id="universidad-popup" class="btn btn-info col-md-2 col-xs-12 col-lg-4 col-xl-2">Agregar Universidad</a>
							<table class="table table-hover table-striped col-md-12 col-xs-12 col-lg-12 col-xl-12">
								<thead>
									<th>Ciudad</th>
									<th>Nombre</th>
