...
<body style="margin: 0; padding: 0; width: 100%; background-color: #F2F4F=
6;">
      ...
      <td style="width: 100%; margin: 0; padding: 0; border-top: 1px solid #EDEFF2; border-bottom: 1px solid #EDEFF2; background-color: #FFF;" width="100%">
          ...
          <tr>
            <td style="font-family: Arial, Helvetica Neue, Helvetica, sans-serif; padding: 35px;">
              ...
              <tr>
                <td align="center">
                 <a href="{{url('users/activation',$token)}}"
         ...
         <!-- Outro -->
         <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
          Si no fuiste tu has caso omiso a este mensaje
        </p>
        <!-- Salutation -->
        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
          Saludos,<br>MyRommieTeam
        </p>
          ...
          <tr>
            <td style="font-family: Arial,Helvetica Neue, Helvetica, sans-serif;">
              <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                Si tienes problemas con el boton de activacion copia y pega en enlace que aparece acontinuacion:
              </p>

              <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
              <a style="color: #3869D4;" href="{{url('users/activation',$token)}}" target="_blank">
...
<tr>
  <td>
    <table style="width: auto; max-width: 570px; =
    margin: 0 auto; padding: 0; text-align: center;" align="center" width="=
    570" cellpadding="0" cellspacing="0">
    <tr>
      <td style="font-family: Arial,
      Helvetica Neue, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
      <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
        &copy; 2016
        <a style="color: #3869D4;" href="{{url('/')}}" target="_blank">My Rommie</a>.
        All rights reserved.
      </p>
    </td>
  </tr>
